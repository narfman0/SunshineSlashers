...
namespace SunshineSlashers
{
    ...
    public class NormalMappedRoom
    {
        ...
        public NormalMappedRoom(GraphicsDevice device,
                                float size,
                                float height,
                                ...
                                float wallTileFactorY)
        {
            ...
            GenerateRoom(size, height, floorTileFactor, ceilingTileFactor,
                wallTileFactorX, wallTileFactorY);
        }
        ...
        private void GenerateRoom(float floorSize, float wallHeight, float floorTileFactor,
                                  float ceilingTileFactor, float wallTileFactorX,
                                  float wallTileFactorY)
        {
            ...
            vertexDeclaration = new VertexDeclaration(graphicsDevice,
                NormalMappedVertex.VertexElements);
