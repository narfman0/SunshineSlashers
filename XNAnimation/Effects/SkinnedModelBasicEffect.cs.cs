...
namespace XNAnimation.Effects
{
    ...
    public class SkinnedModelBasicEffect : Effect
    {
        ...
        public ShaderProfile VertexShaderProfile
        {
            get
            {
                return GetShaderProfile(
                    CurrentTechnique.Annotations["vertexShaderProfile"].GetValueString());
            }
        }
        ...
        public ShaderProfile PixelShaderProfile
        {
            ...
            {
                return GetShaderProfile(
                    CurrentTechnique.Annotations["pixelShaderProfile"].GetValueString());
            }
        }
        ...
        private ShaderProfile GetShaderProfile(string annotation)
        {
            ...
            /*
            if (annotation.Equals(ShaderProfile.VS_2_0.ToString()))
                return ShaderProfile.VS_2_0;
            else if (annotation.Equals(ShaderProfile.VS_2_A.ToString()))
                return ShaderProfile.VS_2_A;
            else if (annotation.Equals(ShaderProfile.VS_3_0.ToString()))
                return ShaderProfile.VS_3_0;
            else if (annotation.Equals(ShaderProfile.PS_2_0.ToString()))
                return ShaderProfile.PS_2_0;
            else if (annotation.Equals(ShaderProfile.PS_2_A.ToString()))
                return ShaderProfile.PS_2_A;
            else if (annotation.Equals(ShaderProfile.PS_3_0.ToString()))
                return ShaderProfile.PS_3_0;
            else
